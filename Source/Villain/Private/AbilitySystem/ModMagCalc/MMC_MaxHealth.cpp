...
{
	// AURA EXAMPLE
	/*VigorDef.AttributeToCapture = UVillainAttributeSet::GetVigorAttribute();
	VigorDef.AttributeSource = EGameplayEffectAttributeCaptureSource::Target;
	VigorDef.bSnapshot = false;
	*/

	MaxHealthDef.AttributeToCapture = UVillainAttributeSet::GetMaxHealthAttribute();
...
float UMMC_MaxHealth::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
	...
	*/
	...
	//TODO: Need to capture MaxHealthDef? Only if using other attribute to scale. 
	float MaxHealth = 0.f;
